...
def martingale_buy(investment, shares, price, losses):
    # 주식 매수
...
# 초기값 설정
investment_base = get_balance("KRW")# 초기 투자 금액
investment = investment_base*.1 # 초기 투자 금액2
shares = investment / get_current_price("KRW-XRP")  # 초기 주식 수
price = get_current_price("KRW-XRP")  # 초기 주식 가격
losses = 0  # 초기 손실 금액

schedule.every(30).minutes.do(run_martingale_buy)
